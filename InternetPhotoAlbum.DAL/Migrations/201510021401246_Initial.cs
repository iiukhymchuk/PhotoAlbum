namespace InternetPhotoAlbum.DAL.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FileExtention = c.String(maxLength: 8),
                        FilePath = c.String(maxLength: 260),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ImageDescriptions", "OwnerId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.ImageDescriptions", new[] { "OwnerId" });
